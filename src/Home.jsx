...
const StaticMenu = () => {
  ...
  return (
    ...
    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <a className="nav-item nav-link" onClick={homeSection.onClick} selected={homeSection.selected}>
          Home
        </a>
    ...
    <React.Fragment>
     ...
     <Section id="estudios" className=" text-center p-5">
       ...
       <div className="col-12">
         ...
         <ul className="ml-4">
           <li>
             <p>-Instuto seminario franciscano</p>
             <p><span className="span-sub">2011</span></p>
           </li>
         
           <li>
             <p className="mt-2">-Analista en informatica</p>
             <p><span className="span-sub">universidad nacional del oeste</span></p>
           </li>
...
const footer = () => {
  ...
  return ( 
      ...
      <footer className="footer">
        <p className="text-center">Ezequiel Gallardo  {newYear}  echo con MERN + HEROKU 💪  </p>
      </footer>
      </>
   );
}
